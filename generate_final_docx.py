...
[6] UI Recalculates Severity (Ranks Alerts, Colors Map)
          |
          v
[7] AI Processing Engine Ingests Data -> Pushes Predictive Failure Alert
"""
p = doc.add_paragraph()
...
doc.save('Detailed_Project_ALO_Architecture_Final.docx')
print("Detailed Word document with ASCII diagrams created successfully.")
